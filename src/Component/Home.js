...
class Home extends Component {
  ...
  addBook() {
    axios.post('https://dev-books-db1a2.firebaseio.com/books.json/', this.state.newBookData).then((response) => {
  ...
  updateBook() {
    ...
    axios.put('https://dev-books-db1a2.firebaseio.com/books/' + this.state.editBookData.id +'/.json', {
      title, rating
    }).then((response) => {
      this._refreshBooks();
  ...
  deleteBook(id) {
    axios.delete('https://dev-books-db1a2.firebaseio.com/books/' + id+'.json').then((response) => {
      this._refreshBooks();
    });
  }
  _refreshBooks() {
    axios.get('https://dev-books-db1a2.firebaseio.com/books.json/')
    // .then((response) => {
    //   this.setState({
    //     books: response.data
    //   })
